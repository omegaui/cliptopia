...
class PowerModeLoadedStateView extends StatefulWidget {
  const PowerModeLoadedStateView({
    super.key,
  ...
  @override
  State<PowerModeLoadedStateView> createState() =>
      _PowerModeLoadedStateViewState();
}

class _PowerModeLoadedStateViewState extends State<PowerModeLoadedStateView> {
  ...
  void start() {
    if (!TempStorage.get(StorageKeys.clipboardLoadedKey,
        fallback: StorageValues.defaultClipboardLoadedValue)) {
      TempStorage.set(StorageKeys.clipboardLoadedKey, true);
      Future(
        () {
          FlutterView view =
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (PowerDataHandler.searchType !=
                          ...
                          const Gap(25),
                          CollectionPanel(controller: widget.controller),
                          const Gap(35),
                        ],
                      ],
                    ),
